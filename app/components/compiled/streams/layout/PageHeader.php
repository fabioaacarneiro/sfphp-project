...
{
    return (static function (array $__props): \SfphpProject\src\View\Sfht { extract($__props); ob_start(); echo '<header class="bg-gradient-to-r from-indigo-600 to-blue-600 text-black py-8">
            <div class="container max-w-4xl mx-auto px-4">
                <h1 class="text-3xl font-bold mb-2 slate-600">HTTP Streaming & SSE</h1>
