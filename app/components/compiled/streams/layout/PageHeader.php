...
{
    return (static function (array $__props): \SfphpProject\src\View\Sfht { extract($__props); ob_start(); echo '<header class="bg-gradient-to-r from-indigo-600 to-blue-600 text-white py-8">
