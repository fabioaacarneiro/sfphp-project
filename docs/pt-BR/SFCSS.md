...
> Verificado contra a folha de estilos gerada · 2.382 classes · 16,8KB gzipped
>
...
- `resources/assets/css/sfcss.css` — 115KB, legível
- `resources/assets/css/sfcss.min.css` — 95KB, minificado (16,8KB gzipped)
